...
export default function SketchListPage() {
  ...
  useEffect(() => {
    fetch("/api/sketches")
      .then((r) => r.json())
      .then((data) => setSketches(Array.isArray(data) ? data : []))
      .catch(console.error)
  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">{t.sketch.title}</h1>
        <p className="text-gray-600 mb-12">{t.sketch.description}</p>
